...
from Sovereign-Omega AI.commands.file_operations import ingest_file, list_files
from Sovereign-Omega AI.config import ConfigBuilder
from Sovereign-Omega AI.memory.vector import VectorMemory, get_memory
...
def configure_logging():
    ...
    return logging.getLogger("Sovereign-Omega AI-Ingestion")
...
def ingest_directory(directory: str, memory: VectorMemory, args):
    ...
    """
    logger = logging.getLogger("Sovereign-Omega AI-Ingestion")
    try:
...
def main() -> None:
    ...
    if args.file:
        ...
        logger.warn(
            ...
            " inside the Sovereign-Omega AI_workspace directory as input."
        )
